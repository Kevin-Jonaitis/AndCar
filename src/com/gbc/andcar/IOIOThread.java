...
public class IOIOThread extends BaseIOIOLooper 
{
		...
		//IRs
		private AnalogInput IRLeft, IRRight, IRRSide, IRLSide;
		...
		public void setup() throws ConnectionLostException 
		{
			try {
				...
				pwmOutputx = ioio_.openPwmOutput(12, 100);
				pwmOutputy = ioio_.openPwmOutput(11, 100);
				motorOutput = ioio_.openPwmOutput(5, 100);
				wheelOutput = ioio_.openPwmOutput(10,100);
				//IRFront = ioio_.openAnalogInput(40);
				IRLeft = ioio_.openAnalogInput(41);
				IRRight = ioio_.openAnalogInput(42);
				//TENTATIVE CHECK THIS!!!!
				IRRSide = ioio_.openAnalogInput(43);
				...
				the_gui.servos.irc.setVoltage(0, IRLeft.getVoltage(), IRRight.getVoltage(), IRLSide.getVoltage(), IRRSide.getVoltage());
